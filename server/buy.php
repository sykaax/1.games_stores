...
<div class="title_shop_window">
		<span>Как приобрести товар</span>
	</div> 
	<div class="row">
		<div class="col-md-4 step_block">
			<div class="step-img"><img src="../img/step-1.png"></div>
			<div class="step">1</div>
			<div class="discr">Выберите понравившийся товар на главной странице. Просто кликните на картинку!</div>
		</div>
		<div class="col-md-4 step_block">
			<div class="step-img"><img src="../img/step-2.png"></div>
			<div class="step">2</div>
			<div class="discr">Ознакомьтись с описанием, затем жмите кнопку "Купить".</div>
		</div>
		<div class="col-md-4 step_block">
			<div class="step-img"><img src="../img/step-3.png"></div>
			<div class="step">3</div>
			<div class="discr">Оплатите товар и получите его в личном кабинете на сайте <a href="https://www.oplata.info/info/" target="_blank">oplata.info</a>, после чего пользуйтесь.</div>
		</div>
	</div> 
</div>
