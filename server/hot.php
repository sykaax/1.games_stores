								...
								<div class="row">
									...
									<div class="col-md-8">
										<div class="height420 margin-bottom25" id="post_photo">
											<img alt="Hot Key" src="../images/hot_rk.jpg">
										</div>
									</div>
									<div class="col-md-4">
								...
								<div class="margin25 ">
									...
									<div class="row margin25 bg-gray img-radius" align="center" id="js-grid-lightbox-masonry" style="height: auto!important;">
										...
										<div class="cbp-item street">
											<a href="../images/post_images/4b2.jpg" class="cbp-caption cbp-lightbox" data-title="Картинка - 1 (Hot Key)">
												<img alt="Картинка - 1 (Hot Key)" class="img-radius" src="../images/post_images/4b2.jpg">
										...
										<div class="cbp-item street">
											<a href="../images/post_images/1g.jpg" class="cbp-caption cbp-lightbox" data-title="Картинка - 2 (Hot Key)">
												<img alt="Картинка - 2 (Hot Key)" class="img-radius" src="../images/post_images/1g.jpg">
										...
										<div class="cbp-item street">
											<a href="../images/post_images/3a2.jpg" class="cbp-caption cbp-lightbox" data-title="Картинка - 3 (Hot Key)">
												<img alt="Картинка - 3 (Hot Key)" class="img-radius" src="../images/post_images/3a2.jpg">
