...
Garry's Mod" src="../images/gm.jpg">
									...
									<div class="col-md-4">
										<div class="bg-gray img-radius border-dots">
											...
											<a href="/oplatend.php?linkgameget=22" class="buy_btn" id="open-close">купить</a>
										</div>
								...
								<div class="margin25 ">
									...
									<div class="row margin25 bg-gray img-radius" align="center" id="js-grid-lightbox-masonry" style="height: auto!important;">
										...
										<div class="cbp-item street">
											<a href="../images/post_images/2gm.jpg" class="cbp-caption cbp-lightbox" data-title="Картинка - 1 (
Garry's Mod)">
												<img alt="Картинка - 1 (
Garry's Mod)" class="img-radius" src="../images/post_images/2gm.jpg">
										...
										<div class="cbp-item street">
											<a href="../images/post_images/3gm.jpg" class="cbp-caption cbp-lightbox" data-title="Картинка - 2 (
Garry's Mod)">
												<img alt="Картинка - 2 (
Garry's Mod)" class="img-radius" src="../images/post_images/3gm.jpg">
										...
										<div class="cbp-item street">
											<a href="../images/post_images/4gm.jpg" class="cbp-caption cbp-lightbox" data-title="Картинка - 3 (
Garry's Mod)">
												<img alt="Картинка - 3 (
Garry's Mod)" class="img-radius" src="../images/post_images/4gm.jpg">
